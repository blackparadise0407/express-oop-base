...
import { genHTML } from '@app/utils/genHTML';
...
class MailerService {
    ...
    public createContentHTML({
        ...
        this.html = genHTML({ style, content });
        return this;
    }
...
export function sendForgetPasswordMail(to: string, cc: string[] = []) {
